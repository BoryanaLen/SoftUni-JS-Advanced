function filterEmployees(array, filterString){
    ...
    for (let index = 0; index < filterdedArray.length; index++) {
        const element = filterdedArray[index];
        result.push(`${index}. ${element.first_name} ${element.last_name} - ${element.email}`);
    }
